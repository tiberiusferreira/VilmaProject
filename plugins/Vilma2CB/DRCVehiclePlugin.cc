...
void DRCVehiclePlugin::UpdateStates()
{
    ...
    //Assigning the wheel velocities of each wheel to the variable to be published
    this->flWheelStatePUB = this->flWheelState;
    this->frWheelStatePUB = this->frWheelState;
    this->blWheelStatePUB = this->blWheelState;
    this->brWheelStatePUB = this->brWheelState;
