...
namespace gazebo
{
  class DRCVehicleROSPlugin: public DRCVehiclePlugin
  {
    ...
    //Publish the velocity of the wheels.
    public: ros::Publisher flWheelStatePUB;
    public: ros::Publisher frWheelStatePUB;
    public: ros::Publisher blWheelStatePUB;
    public: ros::Publisher brWheelStatePUB;
