...
{
    this->rosPublishPeriod = common::Time(0.01);
                               ...
                               sdf::ElementPtr _sdf)
{
    ...
    if (this->cheatsEnabled)
    {
        ...
        // Publish wheels velocities//
        //Front left//
        this->flWheelStatePUB = this->rosNode->advertise<std_msgs::Float64>(
                                    this->model->GetName() + "/wheelspeed/flWheel", 10);
        //Front Right//
        this->frWheelStatePUB = this->rosNode->advertise<std_msgs::Float64>(
                                    this->model->GetName() + "/wheelspeed/frWheel", 10);
        //Back Left//
        this->blWheelStatePUB = this->rosNode->advertise<std_msgs::Float64>(
                                    this->model->GetName() + "/wheelspeed/blWheel", 10);
        //Back Right//
        this->brWheelStatePUB = this->rosNode->advertise<std_msgs::Float64>(
                                    this->model->GetName() + "/wheelspeed/brWheel", 10);
