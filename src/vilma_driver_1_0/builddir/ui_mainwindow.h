...
public:
    ...
    QLabel *imu_ang_acel_x;
    QLabel *imu_ang_acel_y;
    QLabel *imu_ang_acel_z;
    ...
    QLineEdit *Set_wheel_direction_x_input_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        CarStatusWidget->setMinimumSize(QSize(384, 500));
        CarStatusWidget->setMaximumSize(QSize(384, 500));
        ...
        layoutWidget->setGeometry(QRect(11, 15, 356, 444));
        ...
        verticalLayout_4->addLayout(Position_gazebo);
        ...
        verticalLayout_4->addLayout(Position_gps);
        ...
        verticalLayout_4->addLayout(Quaternion);
        ...
        verticalLayout_4->addLayout(IMU_quat);
        ...
        verticalLayout_4->addLayout(IMU_ang_vel);
        ...
        imu_ang_acel_x = new QLabel(layoutWidget);
        imu_ang_acel_x->setObjectName(QString::fromUtf8("imu_ang_acel_x"));

        horizontalLayout_10->addWidget(imu_ang_acel_x);

        imu_ang_acel_y = new QLabel(layoutWidget);
        imu_ang_acel_y->setObjectName(QString::fromUtf8("imu_ang_acel_y"));

        horizontalLayout_10->addWidget(imu_ang_acel_y);

        imu_ang_acel_z = new QLabel(layoutWidget);
        imu_ang_acel_z->setObjectName(QString::fromUtf8("imu_ang_acel_z"));

        horizontalLayout_10->addWidget(imu_ang_acel_z);


        IMU_lin_acel->addLayout(horizontalLayout_10);


        verticalLayout_4->addLayout(IMU_lin_acel);
        ...
        verticalLayout_4->addLayout(Lin_vel_gazebo);
        ...
        verticalLayout_4->addLayout(Ang_vel_gazebo);
        ...
        Set_wheel_direction_x_input_2 = new QLineEdit(dockWidgetContents);
        Set_wheel_direction_x_input_2->setObjectName(QString::fromUtf8("Set_wheel_direction_x_input_2"));
        Set_wheel_direction_x_input_2->setGeometry(QRect(320, 50, 113, 23));
        Set_wheel_direction_table = new QTableWidget(dockWidgetContents);
        if (Set_wheel_direction_table->columnCount() < 2)
            Set_wheel_direction_table->setColumnCount(2);
        ...
        Set_wheel_direction_table->setVerticalHeaderItem(0, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(1, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(2, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(3, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(4, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(5, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(6, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(7, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        Set_wheel_direction_table->setVerticalHeaderItem(8, __qtablewidgetitem10);
        ...
        Set_wheel_direction_table->setGeometry(QRect(550, 50, 231, 151));
        Set_wheel_direction_table->setRowCount(100);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        imu_ang_acel_x->setText(QApplication::translate("MainWindow", "X : 0.000", 0, QApplication::UnicodeUTF8));
        imu_ang_acel_y->setText(QApplication::translate("MainWindow", "Y : 0.000", 0, QApplication::UnicodeUTF8));
        imu_ang_acel_z->setText(QApplication::translate("MainWindow", "Z : 0.000", 0, QApplication::UnicodeUTF8));
        ...
        QTableWidgetItem *___qtablewidgetitem2 = Set_wheel_direction_table->verticalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("MainWindow", "1", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = Set_wheel_direction_table->verticalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("MainWindow", "2", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = Set_wheel_direction_table->verticalHeaderItem(2);
        ___qtablewidgetitem4->setText(QApplication::translate("MainWindow", "3", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = Set_wheel_direction_table->verticalHeaderItem(3);
        ___qtablewidgetitem5->setText(QApplication::translate("MainWindow", "4", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = Set_wheel_direction_table->verticalHeaderItem(4);
        ___qtablewidgetitem6->setText(QApplication::translate("MainWindow", "5", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem7 = Set_wheel_direction_table->verticalHeaderItem(5);
        ___qtablewidgetitem7->setText(QApplication::translate("MainWindow", "6", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem8 = Set_wheel_direction_table->verticalHeaderItem(6);
        ___qtablewidgetitem8->setText(QApplication::translate("MainWindow", "7", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem9 = Set_wheel_direction_table->verticalHeaderItem(7);
        ___qtablewidgetitem9->setText(QApplication::translate("MainWindow", "8", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem10 = Set_wheel_direction_table->verticalHeaderItem(8);
