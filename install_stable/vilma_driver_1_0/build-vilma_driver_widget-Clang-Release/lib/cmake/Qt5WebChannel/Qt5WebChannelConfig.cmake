...
set(Qt5WebChannel_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.4.1"
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.4.1/QtWebChannel"
    )
    ...
    foreach(_module_dep ${_Qt5WebChannel_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5WebChannel_FIND_VERSION_EXACT}
    ...
    _populate_WebChannel_target_properties(RELEASE "libQt5WebChannel.so.5.4.1" "" )
