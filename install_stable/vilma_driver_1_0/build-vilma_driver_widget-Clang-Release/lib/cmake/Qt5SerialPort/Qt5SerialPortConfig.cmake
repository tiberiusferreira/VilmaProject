...
set(Qt5SerialPort_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/5.4.1"
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/5.4.1/QtSerialPort"
    )
    ...
    foreach(_module_dep ${_Qt5SerialPort_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5SerialPort_FIND_VERSION_EXACT}
    ...
    _populate_SerialPort_target_properties(RELEASE "libQt5SerialPort.so.5.4.1" "" )
